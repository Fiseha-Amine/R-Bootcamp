...
The interactive graph above shows the living space in every canton in relation to the amount of population.
...
??? Ist das hilfreich??? Hier noch zusätzlich ein Model wäre cool.
```{r}
